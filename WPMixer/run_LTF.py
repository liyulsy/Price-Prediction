...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type = str, default = 'Electricity', choices = ['ETTh1', 'ETTh2', 'ETTm1', 'ETTm2', 'Electricity', 'Weather', 'Traffic'], help = 'dataset')
    ...
    ''' Model Parameters '''
    parser.add_argument('--seq_len', type = int, default = 60, help = 'length of the look back window')
    ...
    data_parser = {
        ...
        'Electricity': {'data': 'all_1H.csv', 'root_path': 'scripts/analysis/crypto_analysis/data/processed_data/1H/', 'T': 'BTC-USDT', 'M': [8, 8], 'S': [1, 1], 'MS': [8, 1]},
