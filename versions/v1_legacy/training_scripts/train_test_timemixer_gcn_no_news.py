...
from models.MixModel.timemixer_gcn_no_news import TimeMixerGCN
from scripts.analysis.crypto_new_analyzer.dataset_no_news import CryptoDatasetNoNews
...
BEST_MODEL_PATH = "Project1/cache/best_timemixer_gcn_no_news_model.pt" # 最佳模型保存路径
